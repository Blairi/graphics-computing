...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//otras transformaciones para el objeto1
		...
		*/
		...
		model = glm::scale(model, glm::vec3(1.0f, 0.72f, 1.00f));
		// renderizado
		...
		*/
		...
		/*
		* Ventanas verdes frontales
		*/
		// transformaciones
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.25f, 0.2f, 0.5f));
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.01f));
		// renderizado
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[0]->RenderMesh(); // ventana izq
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[0]->RenderMesh();// ventana der

		// transformaciones
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -0.35f, 0.5f));
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.01f));
		// renderizado
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[0]->RenderMesh();// puerta

		/*
		* Ventanas laterales verdes
		*/
		// transformaciones
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.5f, 0.2f, 0.23f));
		model = glm::scale(model, glm::vec3(0.01f, 0.3f, 0.3f));
		// renderizado
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[0]->RenderMesh();// ventana lateral izq
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[0]->RenderMesh();// ventana lateral der
		...
		*/
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[2]->RenderMeshGeometry(); // tronco izquierdo
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[2]->RenderMeshGeometry(); // tronco derecho

		/*
		* Pinos, cono verde oscuro
		*/
		model = glm::mat4(1.0);
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[3]->RenderMeshGeometry(); // pino derecho
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[3]->RenderMeshGeometry(); // pino izquierdo
